...
<head>
    ...
    <title>General</title>
    <link rel="stylesheet" href="css/Desglose_General.css">
...
<body>
    ...
    <?php
        ...
        $procedure = $conection->obtenerGeneral();
        $_SESSION['proyectoID'] = $idProyecto;
    ?>

    <div id="titulo">
        <h2 class="text-primary">Desglose General</h2>
        ...
        <table id="tabla-portafolio" class="table table-hover table-bordered">
            <thead>
                <tr class="table-primary">
                    ...
                    <th col-index=2>INGRESO
                        <select class="table-filter" onchange="filter_rows()">
                            <option value="all">Todos</option>
                        </select>
                    </th>
                    <th col-index=3>EGRESO
                        <select class="table-filter" onchange="filter_rows()">
                            <option value="all">Todos</option>
                        </select>
                    </th>
                    ...
                    <th col-index=5>TIPO DE PAGO
                        <select class="table-filter" onchange="filter_rows()">
                            <option value="all">Todos</option>
                        </select>
                    </th>
                    <th col-index=6>PROYECTO
                        <select class="table-filter" onchange="filter_rows()">
                            <option value="all">Todos</option>
                        </select>
                    </th>
                    <th col-index=7>TOTAL</th>
                </tr>
            </thead>
            <tbody>
                <?php
    ...
    <script src="js/Desglose_General.js"></script>
</body>
