    ...
    <div class="pago-form">
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="ingreso-tab-pane" role="tabpanel" aria-labelledby="ingreso-tab" tabindex="0">
                <form id="nuevoPagoIng" action="php/Maquinaria_Procesos.php" class="row needs-validation" method="POST"
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-control selectpicker" data-live-search="true" title="Elige..."
                            name="maquina" id="inputMaquina" onchange="" required>
                            <?php
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="number" name="cantidad" class="form-control" id="inputCantidad" min="1"
                            value="<?php ?>" oninput="calcularImporte()" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <input type="number" name="precioUnitario" class="form-control" id="inputPrecioUn" min="0"
                                step="0.01" value="<?php ?>" oninput="calcularImporte()" required>
                            <div class="invalid-feedback">
                                Ingrese un número válido.
                            </div>
                        </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <div class="input-group has-validation">
                            <span class="input-group-text">$</span>
                            <input type="number" name="modificacion" class="form-control" id="inputModificacion" min="0"
                                step="0.01" value="<?php ?>" oninput="calcularImporte()" required>
                            <div class="invalid-feedback">
                                Ingrese un número válido.
                            </div>
            ...
            <div class="tab-pane fade" id="egreso-tab-pane" role="tabpanel" aria-labelledby="egreso-tab" tabindex="0">
                <form id="nuevoPagoEgr" action="php/Maquinaria_Procesos.php" class="row needs-validation" method="POST"
                    enctype="multipart/form-data" novalidate>
                    <div class="form-group" hidden>
                        <div class="form-check form-check-inline">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-control selectpicker" data-live-search="true" title="Elige..."
                            name="maquina" id="inputMaquinaEg" onchange="" required>
                            <?php
                                $procedure = $conection->gestionMaquinaria(0, '', 0, 0, 'E');
                                while ($rows = $procedure->fetch(PDO::FETCH_ASSOC)) {
                                    echo "<option value=".$rows['idMaquinaria'].">".$rows['nombre']."</option>";
                    ...
                    <div class="form-group col-md-4" id="divConceptoEg">
                        ...
                        <select class="form-control selectpicker" data-live-search="true" title="Elige..."
                            name="concepto" id="inputConceptoA">
                            <?php
