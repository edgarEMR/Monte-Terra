...
<body>
    ...
    <div class="register-form">
        <form id="registroProyecto" action="php/Proyecto_Procesos.php" class="row needs-validation" method="POST"
            ...
            <div class="form-group col-md-4">
                ...
                <select class="form-control selectpicker" data-live-search="true" title="Elige..." name="tipoVivienda[]"
                    id="inputTipoVivienda" multiple required>
                    <?php
            ...
            <div class="form-group col-md-4">
                ...
                <input type="number" name="totalCasas" class="form-control" id="inputTotalCasas" min="1" value="1"
                    value="<?php echo $proyecto->getTotalCasas();?>" required>
                <div class="invalid-feedback">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="number" name="totalEtapas" class="form-control" id="inputTotalEtapas" min="1"
                    value="<?php echo $proyecto->getTotalEtapas();?>" required>
                <div class="invalid-feedback">
                    Ingrese un número válido.
                </div>
            </div>
            <div class="form-group col-md-4">
                <label for="inputM2Base">M2 Base</label>
                <div class="input-group has-validation">
                    <input type="number" name="m2Base" class="form-control" id="inputM2Base" min="1"
                        value="<?php echo $proyecto->getMetrosBase();?>" required>
            ...
            <div class="form-group col-md-4">
                ...
                <input type="number" name="prototipos" class="form-control" id="inputPrototipo" min="1"
                    value="<?php echo $proyecto->getPrototipos();?>" required>
                <div class="invalid-feedback">
                    Ingrese un número válido.
                </div>
            </div>
            <div class="form-group col-md-4">
                ...
                <input type="number" name="manzanas" class="form-control" id="inputManzana" min="1"
                    value="<?php echo $proyecto->getManzanas();?>" required>
                <div class="invalid-feedback">
                    Ingrese un número válido.
                </div>
            </div>
