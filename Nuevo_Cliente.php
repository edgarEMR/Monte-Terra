    ...
    <div class="register-form">
        <form id="registroProyecto" action="php/Cliente_Procesos.php" class="row needs-validation" method="POST" enctype="multipart/form-data" novalidate>
            ...
            <div class="form-group col-md-3">
                ...
                <select class="form-control selectpicker" data-live-search="true" title="Elige..." name="calle" id="inputCalle" required>
                </select>
                <div class="invalid-feedback">
                    Elija una opción.
                </div>
            ...
            <div class="form-group col-md-3">
                ...
                <select class="form-control selectpicker" data-live-search="true" title="Elige..." name="lote" id="inputLote" required>
                </select>
                <div class="invalid-feedback">
                    Elija una opción.
                </div>
