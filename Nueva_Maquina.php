...
<body>
    ...
    <div id="maquinaria" class="table-responsive">
        ...
        <div class="register-form">
            <form id="registroProyecto" action="php/Maquinaria_Procesos.php" class="row needs-validation" method="POST"
                enctype="multipart/form-data" novalidate>
                <div class="form-group input-group-sm col-md-4">
                    <label for="inputImporte">Importe</label>
                    <div class="input-group has-validation">
                        <span class="input-group-text">$</span>
                        <input type="number" name="importe" class="form-control" id="inputImporte" min="0" step="0.01"
                            required value="<?php ?>">
                ...
                <div class="form-group col-md-4">
                    ...
                    <select class="form-control selectpicker" data-live-search="true" title="Elige..." name="concepto"
                        id="inputConcepto" required>
