...
<head>
    ...
    <link rel="stylesheet" href="css/Nuevo_Banco.css">
...
<body>
    ...
    <div class="register-form">
        <form id="registroProyecto" action="php/Banco_Procesos.php" class="row needs-validation" method="POST" enctype="multipart/form-data" novalidate>
            <div class="form-group input-group-sm">
                <label for="nombreBanco">Nombre</label>
                <input type="text" name="nombreBanco" class="form-control" id="inputNombre"
    ...
    <div id="tabla-desglose-aportador" class="table-responsive">    
        <table id="tabla-aportador" class="table table-hover table-bordered">
            ...
            <tbody>
                <?php
                    $procedure = $conection->gestionBanco(0, '', 'S');
    ...
    <script src="js/Nuevo_Banco.js"></script>
</body>
</html>