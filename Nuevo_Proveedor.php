...
<body>
    ...
    <div class="register-form">
        <form id="registroProyecto" action="php/Proveedor_Procesos.php" class="row needs-validation" method="POST" enctype="multipart/form-data" novalidate>
            <div class="form-group input-group-sm col-md-6">
                <label for="RFCProveedor">RFC</label>
                <input type="text" name="RFCProveedor" class="form-control" id="inputRFC" placeholder="XAXX010101000"
            ...
            <div class="form-group input-group-sm col-md-6">
                ...
                <input type="text" name="nombreProveedor" class="form-control" id="inputNombre"
