...
<body>
    ...
    <?php
        ...
        if (isset($_GET['id'])) {
            $idProyecto = $_GET['id'];
            $procedure = $conection->spObtenerCotizacion($idProyecto, 0, 2);
            ...
            <tbody>
                <?php
                    ...
                    while($rows = $procedure->fetch(PDO::FETCH_ASSOC)){
                        echo "<tr>";
                        echo "<td><a onclick=\"sendVariables('Cotizacion_Detalle.php', " . $rows['idEtapa'] . ", 'id');\">Etapa " . $rows['numeroEtapa'] . "</a></td>";
